    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-md-4"><!-- Colone Droite -->
                <br>
                <div onclick="#control" class="alert alert-danger HCenter"><!-- Alerte Controle -->
                    <strong>3</strong> objet(s) sont en instance de correction.
                </div><!-- Alerte Controle Fin -->
                <div onclick="#Devoirs" class="alert alert-warning HCenter"><!-- Alerte Devoir -->
                    <strong>1</strong> devoir(s) doivent être rendu aujourd'hui.
                </div><!-- Alerte Devoir Fin -->			
